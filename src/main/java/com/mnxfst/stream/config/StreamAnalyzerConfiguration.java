 ...
 */
package com.mnxfst.stream.config;
...
/**
 * Holds all required configuration for setting up a stream analyzer along
 * with all listeners, dispatchers and pipelines
 * @author mnxfst
 * @since 05.03.2014
 *
 */
@JsonRootName ( value = "streamAnalyzerServerConfiguration" )
public class StreamAnalyzerConfiguration implements Serializable {
	 ...
	 * Default constructor
	 */
	public StreamAnalyzerConfiguration() {		
	}
